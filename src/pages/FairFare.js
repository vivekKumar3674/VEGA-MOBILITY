...
const fareData = [
  { mode: '🚇 Metro', official: 40, surge: 40, saving: 0 },
  { mode: '🚗 Auto', official: 85, surge: 210, saving: 125 },
  { mode: '🚕 Cab', official: 120, surge: 340, saving: 220 },
  { mode: '🚌 Bus', official: 15, surge: 15, saving: 0 },
];
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#020a06', paddingTop: '100px' }}>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '40px 24px', position: 'relative', zIndex: 1 }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '16px', lineHeight: '1.7', marginBottom: '48px' }}>Government-rate pricing. No surge. No hidden charges.</p>
        ...
        <div style={{
          ...
          <p style={{ color: '#fbbf24', fontSize: '14px' }}>Peak hour — Cab apps showing <strong>2.8x surge</strong>. VEGA shows you the real government rate.</p>
        </div>
